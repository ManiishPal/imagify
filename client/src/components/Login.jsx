    ...
    <div className='fixed left-0 right-0 bottom-0 top-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white rounded-xl p-10 text-slate-500'>
            ...
            {state !== 'Login' && <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                ...
                type="text" placeholder='Write Your Name' className='outline-none text-sm' required />
            </div>}
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                ...
                type="email" placeholder='Your Email' className='outline-none text-sm' required />
            </div>
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                ...
                type="password" placeholder='Your Password' className='outline-none text-sm' required />
            </div>
