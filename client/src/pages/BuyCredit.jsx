...
const BuyCredit = () => {
  ...
  return (
    ...
    className='min-h-[80vh] text-center pt-4 mb-10'>
      ...
      <h1 className='text-center text-3xl font-medium mv-6 sm:mb-10'>Choose the plan </h1>

      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {
          plans.map((item, index) => (
            <div className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-110 transition-all duration-500' key={index}>
